...
<meta name="theme-color" content="#712cf9">
    ...
    <link href="https://getbootstrap.com/docs/5.3/examples/features/features.css" rel="stylesheet">
  </head>
  <body>
...
<main>
  ...
  <div class="container px-4 py-5" id="featured-3">
    <h2 class="pb-2 border-bottom">Компания Робосайт - вещуший разработчик веб сайтов</h2>
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      <div class="feature col">
        <div class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
          <svg class="bi" width="1em" height="1em"><use xlink:href="#collection"/></svg>
        </div>
        <h3 class="fs-2">Мои товары</h3>
        <p>В этом разделе представлены товары моего производства.</p>
      ...
      <div class="feature col">
        ...
        <h3 class="fs-2">Информация о компании</h3>
        <p>В этом разделе предстставлены все данные нашей компании</p>
        <a href="#" class="icon-link d-inline-flex align-items-center">
          Call to action
          <svg class="bi" width="1em" height="1em"><use xlink:href="#chevron-right"/></svg>
        </a>
